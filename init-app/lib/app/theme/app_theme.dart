...
class AppTheme {
  ...
  static TextStyle _buttonTextStyle(Color color) {
    return AppTextStyles.buttonText.copyWith(color: color, inherit: false);
  }
    ...
    return ThemeData(
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          textStyle: _buttonTextStyle(AppColors.primary),
        ),
      ),
    ...
    return ThemeData(
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          textStyle: _buttonTextStyle(AppColors.primaryLight),
        ),
      ),
